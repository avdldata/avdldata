...
const VOLUME_TO_ML: Readonly<Record<string, number>> = {
  ...
  'fl oz': 29.5735295625,
  floz: 29.5735295625,
  // Dutch measures. A Dutch eetlepel is 15 ml and a theelepel 5 ml — the same
  // convention the domain uses (ML_PER_TBSP / ML_PER_TSP), not the US 14,79.
  el: 15,
  eetlepel: 15,
  eetlepels: 15,
  tl: 5,
...
const COUNT_UNITS = new Set([
  ...
  'fillet',
  'fillets',
  // Dutch count words: a clove, a slice, a sprig, a stalk, a leaf is one thing.
  'teen',
  'tenen',
  'teentje',
  'teentjes',
...
const PACKAGE_UNITS = new Set([
  ...
  'dram',
  'drams',
  // Dutch packages and vague measures: refused for the same reason as "can"
  // and "pinch" — the size lives on a package, or nowhere.
  'blik',
  'blikken',
  'blikje',
  'blikjes',
