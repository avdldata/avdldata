...
export const SEED_INGREDIENTS: readonly CanonicalIngredient[] = [
  // ---- Groente & fruit ----------------------------------------------------
  ing('ui', 'Ui', 'groente-fruit', 'g', 'semi', {
    pieceWeightGrams: 110,
    synonyms: ['gele ui', 'uien'],
  }),
  ing('rode-ui', 'Rode ui', 'groente-fruit', 'g', 'semi', { pieceWeightGrams: 110 }),
  ing('knoflook', 'Knoflook', 'groente-fruit', 'g', 'semi', {
    pieceWeightGrams: 5,
    synonyms: ['teentje knoflook', 'knoflookteen'],
  }),
  ing('wortel', 'Wortel', 'groente-fruit', 'g', 'semi', {
    pieceWeightGrams: 80,
    synonyms: ['winterpeen', 'wortelen'],
  }),
  ...
  ing('paprika-rood', 'Rode paprika', 'groente-fruit', 'g', 'perishable', {
    pieceWeightGrams: 160,
    synonyms: ['paprika rood', 'paprika'],
  }),
  ing('paprika-geel', 'Gele paprika', 'groente-fruit', 'g', 'perishable', {
    pieceWeightGrams: 160,
  }),
  ...
  ing('champignons', 'Champignons', 'groente-fruit', 'g', 'perishable', {
    synonyms: ['witte champignons'],
  }),
  ...
  ing('aardappel', 'Aardappelen', 'groente-fruit', 'g', 'semi', {
    synonyms: ['kruimige aardappelen'],
  }),
  ing('zoete-aardappel', 'Zoete aardappel', 'groente-fruit', 'g', 'semi', {
  ...
  ing('kipfilet', 'Kipfilet', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
    synonyms: ['kipfilet naturel', 'kipborst'],
  }),
  ing('kipdijfilet', 'Kipdijfilet', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
  }),
  ing('gehakt-rund', 'Rundergehakt', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
  }),
  ...
  ing('varkenshaas', 'Varkenshaas', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
  }),
  ing('spekblokjes', 'Spekblokjes', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
  }),
  ing('runderlever', 'Runderlever', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
    pregnancyRisks: ['lever-vitamine-a'],
  }),
  ing('zalmfilet', 'Zalmfilet', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
    allergens: ['vis'],
  }),
  ing('gerookte-zalm', 'Gerookte zalm', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
    allergens: ['vis'],
    pregnancyRisks: ['rauwe-vis'],
  }),
  ing('tonijnsteak', 'Verse tonijnsteak', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
    allergens: ['vis'],
    pregnancyRisks: ['kwikrijke-vis'],
  }),
  ing('kabeljauw', 'Kabeljauwfilet', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
    allergens: ['vis'],
    synonyms: ['witvis'],
  }),
  ing('garnalen', 'Garnalen', 'vlees-vis-vega', 'g', 'perishable', {
    vegetarian: false,
    vegan: false,
    allergens: ['schaaldieren'],
  }),
  ing('ei', 'Eieren', 'vlees-vis-vega', 'piece', 'semi', {
    pieceWeightGrams: 58,
    vegan: false,
    allergens: ['ei'],
  }),
  ...
  // ---- Zuivel -------------------------------------------------------------
  ing('melk', 'Halfvolle melk', 'zuivel', 'ml', 'perishable', {
    density: 1.03,
    vegan: false,
    allergens: ['melk'],
  }),
  ing('yoghurt', 'Volle yoghurt', 'zuivel', 'ml', 'perishable', {
    density: 1.03,
    vegan: false,
    allergens: ['melk'],
  }),
  ing('griekse-yoghurt', 'Griekse yoghurt', 'zuivel', 'g', 'perishable', {
    density: 1.05,
    vegan: false,
    allergens: ['melk'],
  }),
  ing('kookroom', 'Kookroom', 'zuivel', 'ml', 'semi', {
    density: 1.0,
    vegan: false,
    allergens: ['melk'],
  }),
  ing('creme-fraiche', 'Crème fraîche', 'zuivel', 'g', 'perishable', {
    density: 1.0,
    vegan: false,
    allergens: ['melk'],
  }),
  ing('geraspte-kaas', 'Geraspte belegen kaas', 'zuivel', 'g', 'semi', {
    vegan: false,
    allergens: ['melk'],
  }),
  ing('parmezaan', 'Parmezaanse kaas', 'zuivel', 'g', 'semi', {
    vegan: false,
    allergens: ['melk'],
  }),
  ing('mozzarella', 'Mozzarella', 'zuivel', 'g', 'perishable', {
    vegan: false,
    allergens: ['melk'],
  }),
  ing('feta', 'Feta', 'zuivel', 'g', 'perishable', { vegan: false, allergens: ['melk'] }),
  ing('blauwe-kaas', 'Blauwe kaas', 'zuivel', 'g', 'perishable', {
    vegan: false,
    allergens: ['melk'],
    pregnancyRisks: ['ongepasteuriseerd'],
  }),
  ...
  ing('lasagnebladen', 'Lasagnebladen', 'brood-granen', 'g', 'pantry', {
    allergens: ['gluten', 'ei'],
  }),
  ...
  ing('wraps', 'Tarwewraps', 'brood-granen', 'piece', 'semi', {
    pieceWeightGrams: 62,
    allergens: ['gluten'],
  }),
  ing('pitabrood', 'Pitabrood', 'brood-granen', 'piece', 'semi', {
    pieceWeightGrams: 60,
    allergens: ['gluten'],
  }),
  ...
  // ---- Conserven ----------------------------------------------------------
  ing('tomatenblokjes', 'Tomatenblokjes', 'conserven', 'g', 'pantry', {
    synonyms: ['tomaten in blik'],
  }),
  ...
  ing('tonijn-blik', 'Tonijn in blik', 'conserven', 'g', 'pantry', {
    vegetarian: false,
    vegan: false,
    allergens: ['vis'],
  }),
  ...
  ing('peper', 'Zwarte peper', 'kruiden-specerijen', 'g', 'pantry', {
    density: 0.5,
    pantryStaple: true,
  }),
  ...
  ing('sojasaus', 'Sojasaus', 'kruiden-specerijen', 'ml', 'pantry', {
    density: 1.1,
    allergens: ['soja', 'gluten'],
  }),
  ing('ketjap', 'Ketjap manis', 'kruiden-specerijen', 'ml', 'pantry', {
    density: 1.2,
    allergens: ['soja', 'gluten'],
  }),
  ing('sambal', 'Sambal', 'kruiden-specerijen', 'g', 'pantry', { density: 1.0 }),
  ing('rode-currypasta', 'Rode currypasta', 'kruiden-specerijen', 'g', 'pantry', {
    density: 1.0,
    allergens: ['schaaldieren'],
  }),
  ing('paprikapoeder', 'Paprikapoeder', 'kruiden-specerijen', 'g', 'pantry', { density: 0.5 }),
  ing('komijn', 'Komijnpoeder', 'kruiden-specerijen', 'g', 'pantry', {
    density: 0.5,
    synonyms: ['djinten'],
  }),
  ...
  ing('italiaanse-kruiden', 'Italiaanse kruiden', 'kruiden-specerijen', 'g', 'pantry', {
    density: 0.3,
  }),
  ...
  ing('groentebouillon', 'Groentebouillonblokjes', 'kruiden-specerijen', 'g', 'pantry', {
    allergens: ['selderij'],
  }),
  ...
  ing('mosterd', 'Mosterd', 'kruiden-specerijen', 'g', 'pantry', {
    density: 1.0,
    allergens: ['mosterd'],
  }),
  ing('honing', 'Honing', 'kruiden-specerijen', 'g', 'pantry', { density: 1.4, vegan: false }),
  ing('pindakaas', 'Pindakaas', 'kruiden-specerijen', 'g', 'pantry', {
    density: 1.0,
    allergens: ['pinda'],
  }),
