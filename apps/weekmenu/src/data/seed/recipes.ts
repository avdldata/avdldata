...
const BASE_RECIPES: readonly AuthoredRecipe[] = [
  ...
  // --- Extra plantaardige gerechten -----------------------------------------
  //
  // Een veganistisch huishouden hield tien gerechten over, waarvan zeven op
  // peulvruchten. Met "hoogstens drie keer hetzelfde hoofdeiwit" en "hoogstens
  // één soep" is daar geen week van zeven uit te bouwen zonder de variatieregels
  // te breken. Deze zeven verbreden vooral wat er níét was: gerechten op tofu,
  // tempeh en seitan, en groentegerechten zonder uitgesproken eiwitbron.

  r(
    'tofu-teriyaki-broccoli',
    'Tofu teriyaki met broccoli',
    'aziatisch',
    'plantaardig-vlees',
    ['rijst', 'vegetarisch', 'veganistisch', 'snel'],
    {
      description: 'Krokant gebakken tofu in een zoetzoute saus, met broccoli en rijst.',
      prep: 12,
      cook: 18,
      steps: [
        'Snijd de tofu in blokjes en dep ze droog.',
        'Bak de tofu in zonnebloemolie tot alle kanten goudbruin zijn.',
        'Voeg sojasaus, gember en knoflook toe en laat inkoken tot een glazuur.',
        'Roerbak de broccoli kort mee en serveer met rijst.',
      ],
      ingredients: [
        li('tofu', 400, 'g'),
        li('broccoli', 500, 'g'),
      ...
      nutrition: n(612, 29, 78, 20, 7.8, 2.4),
    },
  ),

  r(
    'tempeh-pindasaus-bulgur',
    'Bulgur met tempeh en pindasaus',
    'aziatisch',
    'plantaardig-vlees',
    ['vegetarisch', 'veganistisch', 'comfortfood'],
    {
      description: 'Gemarineerde tempeh met een romige pindasaus over mie en wokgroenten.',
      prep: 15,
      cook: 15,
      steps: [
        'Snijd de tempeh in plakjes en bak ze bruin in olie.',
        'Roer pindakaas los met sojasaus, wat water en de rode peper.',
        'Wok de paprika en wortel beetgaar.',
        'Wel de bulgur, schep alles door elkaar en giet de saus erover.',
      ],
      ingredients: [
        li('tempeh', 400, 'g'),
        li('bulgur', 300, 'g'),
        ...
        li('wortel', 200, 'g'),
        li('sojasaus', 40, 'ml'),
        li('rode-peper', 1, 'piece', true),
        li('knoflook', 2, 'piece'),
        li('zonnebloemolie', 2, 'tbsp'),
        li('zout', 2, 'g'),
      ],
      nutrition: n(742, 35, 76, 33, 9.2, 2.1),
    },
  ),

  r(
    'tofu-shakshuka-stijl',
    'Tofu in pittige tomatensaus',
    'mediterraan',
    'plantaardig-vlees',
    ['brood', 'vegetarisch', 'veganistisch', 'eenpansgerecht'],
    {
      description: 'Verkruimelde tofu in een saus van tomaat, paprika en komijn, met brood erbij.',
      prep: 10,
      cook: 22,
      steps: [
        'Fruit ui, knoflook en paprika zacht in olijfolie.',
        'Voeg tomatenblokjes, tomatenpuree, komijn en paprikapoeder toe.',
        'Verkruimel de tofu erdoor en laat een kwartier pruttelen.',
      ...
      nutrition: n(548, 28, 55, 22, 11.4, 2.6),
    },
  ),

  r(
    'geroosterde-groenten-couscous',
    'Geroosterde groenten met couscous',
    'mediterraan',
    'geen',
    ['vegetarisch', 'veganistisch', 'snel', 'budget'],
    {
      ...
      cook: 25,
      steps: [
        'Snijd de groenten in grove stukken en meng ze met olijfolie en kruiden.',
        'Rooster ze 25 minuten op 220 graden.',
        'Wel de couscous in hete groentebouillon.',
        'Schep de groenten erdoor en maak af met citroensap.',
      ],
      ingredients: [
        li('courgette', 400, 'g'),
        li('aubergine', 350, 'g'),
  ...
  r(
    ...
    ['rijst', 'vegetarisch', 'veganistisch', 'comfortfood'],
    {
      ...
      cook: 30,
      steps: [
        'Snijd de pompoen in blokjes en fruit ui en knoflook glazig.',
        'Schep de rijst erdoor en blus af met een deel van de bouillon.',
        'Voeg de pompoen toe en giet de bouillon er scheutje voor scheutje bij.',
        'Roer tot de rijst gaar is en maak af met oregano en peper.',
      ],
      ingredients: [
        li('pompoen', 600, 'g'),
        li('witte-rijst', 320, 'g'),
  ...
  r(
    'bloemkool-aardappel-ovenschotel',
    'Ovenschotel met bloemkool en aardappel',
    'nederlands',
    'geen',
    ['aardappelen', 'ovenschotel', 'vegetarisch', 'veganistisch', 'budget'],
    {
      ...
      cook: 35,
      steps: [
        'Kook de aardappelen en bloemkool acht minuten voor.',
        'Meng ze met olijfolie, mosterd en oregano in een ovenschaal.',
        'Strooi paneermeel over de schotel.',
        'Bak 35 minuten op 200 graden tot de korst goudbruin is.',
      ],
      ingredients: [
        li('aardappel', 800, 'g'),
        li('bloemkool', 600, 'g'),
  ...
  r(
    ...
    'mexicaans',
    'peulvrucht',
    ['wraps', 'vegetarisch', 'veganistisch', 'snel', 'budget'],
    {
      description: 'Zwarte bonen met mais en limoen, opgerold in een warme wrap.',
      prep: 10,
      cook: 12,
      steps: [
        'Fruit ui en knoflook, voeg komijn en paprikapoeder toe.',
        'Schep de zwarte bonen en mais erdoor en warm alles door.',
        'Knijp er limoensap over.',
        'Vul de wraps en rol ze op.',
      ],
      ingredients: [
      ...
      nutrition: n(566, 21, 88, 13, 15.8, 2.3),
    },
  ),
];
