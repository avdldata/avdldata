...
export const A_BRAND_PRODUCTS: Readonly<Record<string, readonly ABrandProductSpec[]>> = {
  ...
  melk: [
    {
      brandId: 'brand-campina',
      productName: 'Halfvolle melk',
      amount: 1,
      unit: 'l',
      priceMultiplier: 1.35,
      nutritionPer100: nut(47, 3.6, 4.7, 4.7, 1.5, 1.0, 0, 0.12),
    },
  ],
  yoghurt: [
    {
      ...
      nutritionPer100: nut(66, 3.6, 4.6, 4.6, 3.6, 2.4, 0, 0.13),
    },
  ],
  'griekse-yoghurt': [
    {
      brandId: 'brand-arla',
      productName: 'Griekse stijl yoghurt',
      amount: 500,
      unit: 'g',
      priceMultiplier: 1.4,
      nutritionPer100: nut(123, 5.6, 4.0, 4.0, 9.5, 6.4, 0, 0.13),
    },
  ],
  kookroom: [
    {
      ...
      unit: 'ml',
      priceMultiplier: 1.3,
      nutritionPer100: nut(204, 2.5, 3.3, 3.3, 20, 14, 0, 0.11),
    },
  ],
  'creme-fraiche': [
    {
  ...
  'geraspte-kaas': [
    {
      brandId: 'brand-milner',
      productName: 'Geraspte kaas 30+',
      amount: 200,
      unit: 'g',
      priceMultiplier: 1.35,
      nutritionPer100: nut(302, 30, 0.5, 0.5, 20, 13, 0, 1.9),
    },
  ],
  parmezaan: [
    {
      brandId: 'brand-zanetti',
  ...
  roomboter: [
    {
      brandId: 'brand-campina',
      productName: 'Roomboter gezouten',
      amount: 250,
      unit: 'g',
      priceMultiplier: 1.3,
    },
  ...
  kwark: [
    {
      ...
      unit: 'g',
      priceMultiplier: 1.35,
      nutritionPer100: nut(57, 10.5, 3.8, 3.8, 0.2, 0.1, 0, 0.09),
    },
  ],
  ...
  spaghetti: [
    ...
    {
      brandId: 'brand-dececco',
      productName: 'Spaghetti n.12',
      amount: 500,
      unit: 'g',
      priceMultiplier: 2.1,
      chains: ['ah', 'jumbo'],
      nutritionPer100: nut(353, 13.5, 70, 3.2, 1.4, 0.3, 3.5, 0.01),
    },
  ],
  penne: [
    {
  ...
  mie: [
    {
      brandId: 'brand-conimex',
      productName: 'Mie',
      amount: 250,
      unit: 'g',
      priceMultiplier: 1.7,
      nutritionPer100: nut(361, 10.5, 71, 2.4, 3.1, 1.2, 2.8, 0.9),
    },
  ],
  wraps: [
    {
      brandId: 'brand-santamaria',
      productName: 'Tortilla wraps',
      amount: 8,
      unit: 'piece',
      priceMultiplier: 1.5,
      nutritionPer100: nut(311, 8.4, 49, 3.1, 8.2, 3.6, 2.9, 1.35),
    },
  ],
  bloem: [
    {
  ...
  tomatenblokjes: [
    {
      ...
      unit: 'g',
      priceMultiplier: 1.6,
      nutritionPer100: nut(24, 1.3, 3.6, 3.2, 0.2, 0.03, 1.3, 0.02),
    },
  ],
  passata: [
    {
  ...
  kokosmelk: [
    {
      ...
      unit: 'ml',
      priceMultiplier: 1.5,
      nutritionPer100: nut(160, 1.4, 2.6, 2.2, 15.5, 13.8, 0.4, 0.04),
    },
  ],
  kikkererwten: [
    {
      ...
      nutritionPer100: nut(115, 6.8, 14, 0.7, 2.3, 0.3, 6.0, 0.05),
    },
  ],
  kidneybonen: [
    {
      ...
      unit: 'g',
      priceMultiplier: 1.75,
      nutritionPer100: nut(102, 7.2, 13.5, 0.5, 0.5, 0.1, 7.0, 0.05),
    },
  ],
  'bruine-bonen': [
    {
  ...
  mais: [
    {
      brandId: 'brand-bonduelle',
      productName: 'Maïs',
      amount: 300,
      unit: 'g',
      priceMultiplier: 1.65,
      nutritionPer100: nut(82, 2.9, 15, 4.0, 1.1, 0.2, 2.8, 0.02),
    },
  ],
  doperwten: [
    {
      brandId: 'brand-bonduelle',
      productName: 'Doperwten fijn',
      amount: 750,
      unit: 'g',
      priceMultiplier: 1.5,
    },
  ...
  'tonijn-blik': [
    {
      brandId: 'brand-johnwest',
      productName: 'Tonijnstukken in water',
      amount: 145,
      unit: 'g',
      priceMultiplier: 1.4,
      nutritionPer100: nut(103, 24, 0, 0, 0.8, 0.2, 0, 0.8),
    },
  ],
  olijven: [
    {
      brandId: 'brand-bertolli',
  ...
  sojasaus: [
    {
      ...
      unit: 'ml',
      priceMultiplier: 1.5,
      nutritionPer100: nut(57, 5.5, 5.2, 1.5, 0.1, 0.01, 0.7, 15.2),
    },
  ],
  ketjap: [
    {
  ...
  groentebouillon: [
    {
      ...
      unit: 'g',
      priceMultiplier: 1.6,
      nutritionPer100: nut(196, 9.0, 20, 7.0, 8.5, 4.2, 1.0, 44),
    },
  ],
  pindakaas: [
    {
      ...
      unit: 'g',
      priceMultiplier: 1.45,
      nutritionPer100: nut(619, 24, 13, 5.5, 52, 9.6, 6.5, 0.9),
    },
  ],
  honing: [
    {
      brandId: 'brand-detraay',
      productName: 'Bloemenhoning',
      amount: 350,
      unit: 'g',
      priceMultiplier: 1.7,
    },
  ...
  'vega-gehakt': [
    {
      brandId: 'brand-vivera',
      productName: 'Plantaardig gehakt',
      amount: 200,
      unit: 'g',
      priceMultiplier: 1.5,
      nutritionPer100: nut(178, 18.5, 5.2, 0.9, 8.9, 0.9, 4.1, 1.0),
    },
  ],
  tofu: [
    {
      ...
      unit: 'g',
      priceMultiplier: 1.45,
      nutritionPer100: nut(127, 13.5, 1.2, 0.5, 7.4, 1.1, 1.2, 0.02),
    },
  ],
};
